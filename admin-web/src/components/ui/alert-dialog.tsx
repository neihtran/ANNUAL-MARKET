...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Close
    ...
    {...props}
  >
    <Button className={cn('', className)} {...(props as React.ComponentProps<typeof Button>)} />
  </DialogPrimitive.Close>
));
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Close
    ...
    {...props}
  >
    <Button variant="outline" className={cn('', className)} {...(props as React.ComponentProps<typeof Button>)} />
  </DialogPrimitive.Close>
));
